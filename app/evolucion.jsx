...
const styles = StyleSheet.create({
  ...
  controles: { backgroundColor: '#111827', borderRadius: 12, padding: 16, marginBottom: 24, paddingTop: 5 },
  label: { fontSize: 14, fontWeight: '600', color: '#9CA3AF', marginTop: 35, marginBottom: -10 },
