...
import { isBiserie, NOTE_VALUES } from '../../components/entreno/ExerciseCardUtils';
...
export default function Entreno() {
  ...
  const onOpenNotes = useCallback(async (serieKey, item) => {
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <ExerciseCard
                ...
                currentIsBiserie={currentIsBiserie}
              />
            );
          }}
